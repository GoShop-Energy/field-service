...
class ProjectTask(models.Model):
    ...
    order_line_table = fields.Html(string='HTML Field', compute='_compute_order_line_table')
    ...
    order_line = fields.One2many(
        comodel_name='sale.order.line', related='sale_order_id.order_line', readonly=False)
